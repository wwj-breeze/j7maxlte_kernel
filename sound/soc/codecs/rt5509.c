...
#ifdef CONFIG_MTK_SMARTPA_SOUND
...
#ifndef CONFIG_MTK_SMARTPA_SOUND
...
#endif /* #ifndef CONFIG_MTK_SMARTPA_SOUND */
...
#else
	return NXPExtSpk_set_i2c_client(client);
#endif /* #ifndef CONFIG_MTK_SMARTPA_SOUND */
}
...
#else
	return NXPExtSpk_set_i2c_client(NULL);
#endif /* #ifndef CONFIG_MTK_SMARTPA_SOUND */
}
